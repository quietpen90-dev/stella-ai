...
#chat{flex:1;overflow-y:auto;padding:20px}.message{max-width:800px;margin:12px auto;padding:14px 17px;border-radius:18px;line-height:1.5;white-space:pre-wrap}.user{background:#007aff;color:white}.stella{background:white;box-shadow:0 2px 10px #0001}#inputArea{display:flex;gap:10px;padding:15px;background:#fff;border-top:1px solid #ddd}#message{flex:1;padding:14px;border:1px solid #ccc;border-radius:15px;font-size:16px;outline:none}#send{border:0;border-radius:15px;padding:0 20px;background:#007aff;color:white;font-size:16px}
